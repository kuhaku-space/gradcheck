...
const DUAL = '国際性涵養教育系科目（高度国際性涵養教育科目・専門教育科目）'
  ...
  switch (category) {
    case 'senko-kiso-required':
      return {
        credits,
        category,
        detailCategory: SENMON,
        subCategory: '専攻基礎科目（必修）',
      }
    ...
    case 'kodo-kyoyo':
      return {
        credits,
        category,
        detailCategory: '教養教育系科目（高度教養教育科目）',
        subCategory: '高度教養教育科目（他学部・他研究科等）',
      }
    case 'kokusai':
      return {
        credits,
        category,
        detailCategory: '国際性涵養教育系科目（高度国際性涵養教育科目）',
        subCategory: '',
      }
    case 'unknown':
...
export function courseMetadataForCode(code: string): CourseMetadata | null {
  ...
  if (CORE_REQUIRED.has(code)) {
    return metadata(credits, 'senko-kiso-required')
  }
  if (CORE_ELECTIVE_REQUIRED.has(code)) {
    return metadata(credits, 'senko-kiso-elective-required')
  }
  if (CORE_ELECTIVE.has(code)) {
    return metadata(credits, 'senko-kiso-elective')
  }
